...
27. Create and upload the javadocs:<br>
    Go to the source code directory and run ``mvn compile javadoc:javadoc javadoc:aggregate``<br>
    The javadocs can then be found in the ``target`` directory<br>
